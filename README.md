...
Building evaluation systems, learning agents, and production ML pipelines. Interested in LLM reasoning, RL/RLHF, benchmark design, and scalable AI infrastructure.
...
| :--- | :--- |
| **Languages & Logic** | Python, Java, SQL, JavaScript |
| **AI / Machine Learning** | Computer Vision, NLP, Scikit-Learn, Google Gemini API |
| **Cloud & Infrastructure** | AWS (Cloud Foundations, Data Engineering, Machine Learning), GCP |
